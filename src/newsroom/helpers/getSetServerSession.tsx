...
const secret = process.env.NEXTAUTH_SECRET ? createHash("sha256").update(process.env.NEXTAUTH_SECRET + ":lyniq-newsroom").digest("hex") : (() => { throw new Error("NEXTAUTH_SECRET is required"); })();
